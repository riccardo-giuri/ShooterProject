	...
	BaseLookUpRate(45.f)
{
	...
	CameraBoom->bUsePawnControlRotation = true; // Rotate the arm based on the controller rotation

	// Create a follow Camera 
	FollowCamera = CreateDefaultSubobject<UCameraComponent>(TEXT("FollowCamera"));
	FollowCamera->SetupAttachment(CameraBoom, USpringArmComponent::SocketName); // AttachCamera at the end of cameraBoom
